...
<article id="post-<?php the_ID(); ?>" <?php post_class( ); ?>>
	...
	<?php if ( has_post_thumbnail() ) { // if there is featured image for this post you may wrapper for it ?>
		...
		<div class="featured-text">	
			...
			<span class='post-date updated'><span class="propdesc">Date:</span><?php echo get_the_date(); ?></span>
	...
	<?php if ( !is_single() ) : ?>
		...
		<div class="entry-meta">
			<span class='post-categories'><span class="propdesc">Categories:</span><?php the_category(', '); ?></span> 
			<?php if(comments_open( get_the_ID() )) { ?>
				<span class='post-comments'><span class="propdesc">Comments:</span><?php comments_popup_link( smt_translate( 'noresponses' ), smt_translate( 'oneresponse' ), smt_translate( 'multiresponse' ) ); ?></span>
			<?php }  ?>
			<span class="post-author vcard"><span class="fn"><span class="propdesc">Author:</span><?php echo the_author_posts_link();?></span></span>
		</div>
