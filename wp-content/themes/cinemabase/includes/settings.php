    ...
    $smt_default_options = array(
		...
		'layout'=>array(
			...
			'content'=>array(
				...
				'cuttxt'=>array(
					'type'=>'text','name'=>'cuttxt','value'=>'350','title'=>'The default excerpt length', 'hint'=>'Set the desired character count for posts content on the Front/Category page.'
				),
				'footertext'=>array(
		...
		'translations'=>array(
			...
			'content'=>array(
				...
				'comments'=>array(
					...
					'content'=>array(
						'noresponses'=>array(
							'type'=>'text','name'=>'noresponses','value'=>'0','title'=>'No responses text'
						),
						'oneresponse'=>array(
							'type'=>'text','name'=>'oneresponse','value'=>'1','title'=>'One response text'
						),
						'multiresponse'=>array(
							'type'=>'text','name'=>'multiresponse','value'=>'%','title'=>'Multiple responses text'
						),
